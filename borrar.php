...
$reg=mysqli_query($con,"SELECT id FROM registros WHERE NOMBRE='$_POST[nombre]'");


if ($re=mysqli_fetch_array($reg)){

    mysqli_query($con,"DELETE FROM registros WHERE NOMBRE='$_POST[nombre]'");
    echo '<span style="color: white;">Datos eliminados</span>';

}else{
    echo '<span style="color: white;">Datos No eliminados</span>';
}
?>
        <div class="container">
            <br><br>
