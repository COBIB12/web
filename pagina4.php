...
$result = mysqli_query($con, "UPDATE registros SET nombre='$_POST[nuevo]' WHERE nombre='$_POST[viejo]'") or die(mysqli_error($con));

if (mysqli_affected_rows($con) > 0) {
    echo '<span style="color: white;">Actualización completa</span>';
} else {
    echo '<span style="color: white;">Actualización no realizada: No se encontraron datos</span>';
}
?>
        <div class="container">
            <br><br>
