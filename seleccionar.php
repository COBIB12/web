...
<html>
    ...
    <div id="principal">
            ...
            <p>Este es su de usuario nombres y contraseña</p>
...
$con = mysqli_connect($host, $user, $pw, $db) 
    or die("Problemas al conectar con el servidor: " . mysqli_connect_error());

if (isset($_POST['nombre']) && !empty($_POST['nombre'])) {
    $stmt = $con->prepare("SELECT * FROM registros WHERE nombre = ?");
    ...
    while ($reg = $result->fetch_assoc()) {
        echo '<center>';
        echo '<span style="color: white;">' . htmlspecialchars($reg['nombre']) . '</span><br>';
        echo '<span style="color: white;">' . htmlspecialchars($reg['pw']) . '</span><br>';
        echo '</center>';
    }

    $stmt->close();
} else {
    echo "El campo 'nombre' está vacío o no fue enviado.";
}
